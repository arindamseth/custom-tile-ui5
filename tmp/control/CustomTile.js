...
sap.ui.define(["sap/ui/core/Control", "./CustomTileRenderer", "sap/m/library", "sap/m/Text", "sap/ui/thirdparty/jquery", "sap/ui/core/HTML", "sap/ui/events/PseudoEvents", "sap/ui/core/Icon"], function (Control, CustomTileRenderer, library, Text, jQuery, HTML, PseudoEvents, Icon) {
  ...
  CustomTile.prototype.init = function () {
    ...
    this._oTitle.setProperty("maxLines", 1, true); // Subtitle
    ...
    this._oSubHeader.setProperty("maxLines", 1, true); // Band
    ...
    this._oBand.setProperty("maxLines", 1, true); // Joined
    ...
    this._oJoined.setProperty("maxLines", 1, true); // TEX
    ...
    this._oTexVal.setProperty("maxLines", 1, true); // Years
    ...
    this._oYrsLabel.setProperty("maxLines", 1, true); // REX
