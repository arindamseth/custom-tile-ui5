...
sap.ui.define(["sap/m/library", "sap/base/security/encodeCSS"], function (library, encodeCSS) {
  ...
  CTRenderer._renderTileContent = function (oRm, oControl) {
    ...
    this._renderSubHeader(oRm, oControl); // Sub sub header


    this._renderSubSubHeader(oRm, oControl); // Experience


    this._renderExperience(oRm, oControl); // Assignation
  ...
  CTRenderer._renderSubSubHeader = function (oRm, oControl) {
    ...
    this._renderBand(oRm, oControl); // Joined
  ...
  CTRenderer._renderExperience = function (oRm, oControl) {
    ...
    this._renderTEX(oRm, oControl); // Years start


    this._renderYears(oRm, oControl); // REX start
